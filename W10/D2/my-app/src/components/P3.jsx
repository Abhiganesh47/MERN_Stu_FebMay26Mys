// useRef hook
// useRef creates a mutable refernce object 
// the obj has one property: current
...
export function UserRefIntro(){
    ...
    return(
        <section>
            ...
            <div>
                <h3>2. Store previous values using Useref</h3>
                <p>Current count: {count}</p>
                <p>Previous count: {previousCounterRef.current}</p>
